...
export function Registry() {
  ...
  return (
    <Section id="registry" className="relative bg-[#869EB6] py-8 sm:py-10 md:py-14 lg:py-16 xl:py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="relative bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl overflow-hidden border border-[#83927D]/40 shadow-2xl hover:shadow-[0_10px_50px_rgba(131,146,125,0.3)] transition-all duration-300 group">
          ...
          <div className="relative p-4 sm:p-5 md:p-7 lg:p-9 z-10">
            <div className="flex flex-col items-center space-y-3 sm:space-y-4 md:space-y-5">
              ...
              <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#869EB6] fill-current flex-shrink-0" />
                <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-bold uppercase text-[#0A3428] text-center tracking-[0.12em]">
              ...
              <div className="text-center space-y-1 sm:space-y-1.5 md:space-y-2 max-w-2xl px-2 sm:px-3">
                <div className="relative py-2.5 sm:py-3 md:py-4">
                  ...
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-12 sm:w-16 md:w-24 h-px bg-gradient-to-r from-transparent via-[#83927D]/60 to-transparent"></div>
                  
                  <div className="space-y-1 sm:space-y-1.5 md:space-y-2 font-sans">
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg text-[#0A3428] leading-relaxed">
                      With all that we have, we've been truly blessed.
                    </p>
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg text-[#0A3428] leading-relaxed">
                      Your presence and prayers are all that we request.
                    </p>
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg text-[#0A3428] leading-relaxed pt-1 sm:pt-1.5 md:pt-2">
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-12 sm:w-16 md:w-24 h-px bg-gradient-to-r from-transparent via-[#83927D]/60 to-transparent"></div>
                </div>
              </div>
              ...
              >
                <div className="flex flex-col items-center space-y-2.5 sm:space-y-3 md:space-y-4 pt-3 sm:pt-4 md:pt-5">
                  ...
                  <div className="flex items-center gap-1.5 w-full max-w-md">
                    <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#83927D]/50 to-[#83927D]"></div>
                    <div className="w-1 h-1 bg-[#83927D] rounded-full"></div>
                    <div className="h-px flex-1 bg-gradient-to-l from-transparent via-[#83927D]/50 to-[#83927D]"></div>
                  </div>
                  
                  {/* GCash Label */}
                  <div className="text-center space-y-0.5">
                    <h4 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#0A3428] mb-0.5">
                      GCash
                    </h4>
                  ...
                  {/* QR Code Image */}
                  <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 bg-white rounded-xl p-2 sm:p-2.5 md:p-3 lg:p-4 shadow-xl border-2 border-[#83927D]/40 hover:border-[#83927D]/70 transition-all duration-500 hover:shadow-2xl group/qr">
                    ...
                    {/* Subtle glow effect */}
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#83927D]/0 via-[#83927D]/10 to-[#83927D]/0 opacity-0 group-hover/qr:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                  </div>
                  
                  {/* Instructions */}
                  <div className="text-center space-y-1.5 sm:space-y-2 pt-1">
                    <p className="text-[9px] sm:text-[10px] md:text-xs text-[#0A3428]/70 font-sans">
                      Open GCash app → Scan QR → Enter amount
                    </p>
                    <div className="flex items-center justify-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs md:text-sm text-[#869EB6]">
              ...
              <div className="text-center pt-0.5 sm:pt-1">
                <div className="flex items-center justify-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs md:text-sm lg:text-base text-[#83927D] font-semibold">
                  <Heart className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#869EB6] fill-current flex-shrink-0" />
