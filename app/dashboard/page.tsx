...
export default function DashboardPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#E6CFC9] flex items-center justify-center p-4 relative overflow-hidden">
          ...
          <div className="bg-white/98 backdrop-blur-md rounded-3xl p-8 shadow-2xl border-2 border-white/60">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-white/80 rounded-full mb-4 shadow-lg">
                <Lock className="h-10 w-10 text-[#58171D]" />
              </div>
              <div className="text-xs tracking-[0.25em] uppercase font-semibold text-[#2E0B0F] mb-3 font-sans">welcome {siteConfig.couple.groomNickname}&{siteConfig.couple.brideNickname}</div>
              <h1 className="imperial-script-regular text-5xl font-normal text-[#58171D] mb-2">
                Wedding Dashboard
              </h1>
              <p className="text-[#904945] font-sans text-sm">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-[#2E0B0F] mb-2 font-sans">
                  Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-3 border-2 border-[#904945]/30 focus:border-[#58171D] rounded-xl font-sans placeholder:text-[#A1857A]/60 transition-all duration-300 focus:ring-4 focus:ring-[#58171D]/20 bg-white/80"
                  autoFocus
                />
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-[#58171D] hover:bg-[#904945] text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Access Dashboard
              </Button>
            </form>
  ...
  return (
    <div className="min-h-screen bg-[#E6CFC9] relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/20 via-white/5 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-white/20 via-white/5 to-transparent" />
      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-md shadow-xl border-b-2 border-white/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="imperial-script-regular text-4xl sm:text-5xl font-normal text-[#2E0B0F] mb-1">Wedding Dashboard</h1>
              <p className="text-[#904945] text-sm font-sans">Manage your guest list and RSVPs</p>
            </div>
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-white border-[#904945]/30 text-[#58171D] hover:bg-[#58171D] hover:text-white font-semibold transition-all duration-300 shadow-lg"
              >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center justify-between mb-2">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-[#904945]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#2E0B0F]">{stats.totalGuests}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Total Guests</p>
            <p className="text-xs text-[#A1857A] font-sans mt-1">{stats.total} entries</p>
          </div>
          ...
          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            ...
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Attending</p>
          </div>
          ...
          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center justify-between mb-2">
              <AlertCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#A1857A]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#904945]">{stats.pending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Pending</p>
          </div>

          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center justify-between mb-2">
              <Bell className="h-6 w-6 sm:h-8 sm:w-8 text-[#904945]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#2E0B0F]">{guestRequests.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Requests</p>
          </div>

          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center justify-between mb-2">
              <Crown className="h-6 w-6 sm:h-8 sm:w-8 text-[#A1857A]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#2E0B0F]">{entourage.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Entourage</p>
          </div>

          <div className="bg-white/98 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-white/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center justify-between mb-2">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-[#904945]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#2E0B0F]">{principalSponsors.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#904945] font-sans font-semibold">Principal Sponsors</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
            <button
              ...
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-bold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 ${
                activeTab === "guests"
                  ? "bg-[#58171D] text-white shadow-lg"
                  : "text-[#904945] hover:bg-[#A1857A]/20"
              }`}
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
            <div className="flex-1 w-full">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#A1857A]" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search guests by name or email..."
                  className="w-full pl-10 pr-4 py-2 border-2 border-[#A1857A]/30 focus:border-[#58171D] rounded-xl font-sans placeholder:text-[#A1857A]/60 transition-all duration-300 focus:ring-4 focus:ring-[#58171D]/20 bg-white/80"
                />
              </div>
            </div>
            <Button
              ...
              className="bg-[#58171D] hover:bg-[#904945] text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300"
            >
        ...
        <div className="bg-white/98 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-white/60 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#A1857A]/20">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Name</th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Email</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">RSVP</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans whitespace-nowrap">
                    <span className="flex items-center justify-center gap-1">
                      <Users className="h-4 w-4" />
                      Guests
                    </span>
                  </th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Message</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#A1857A]/30">
                {filteredGuests.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-[#904945] font-sans">
                      {isLoading ? (
                        <div className="flex items-center justify-center gap-2">
                          <RefreshCw className="h-5 w-5 animate-spin text-[#904945]" />
                  ...
                  filteredGuests.map((guest, index) => (
                    <tr key={index} className="hover:bg-[#A1857A]/10 transition-colors">
                      <td className="px-6 py-4 font-semibold text-[#2E0B0F] font-sans">{guest.Name}</td>
                      <td className="px-6 py-4 text-[#904945] font-sans">
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center px-3 py-1.5 bg-[#A1857A]/30 text-[#2E0B0F] rounded-full text-sm font-bold min-w-[3.5rem] border-2 border-[#904945]/40">
                          {guest?.Guest !== undefined && guest?.Guest !== null && guest?.Guest !== '' 
                            ? (parseInt(String(guest.Guest)) || 1) 
                            : 1}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-[#904945] font-sans max-w-xs truncate" title={guest.Message || ""}>
                        {guest.Message || "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 text-[#904945] hover:bg-[#A1857A]/20 rounded-lg transition-colors"
                            title="Edit guest"
                          >
                ...
                <table className="w-full">
                  <thead className="bg-[#A1857A]/20">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Email</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Phone</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans whitespace-nowrap">
                        <span className="flex items-center justify-center gap-1">
                          <Users className="h-4 w-4" />
                          Guests
                  ...
                  <tbody className="divide-y divide-[#A1857A]/30">
                    {filteredRequests.length === 0 ? (
                      ...
                      filteredRequests.map((request, index) => (
                        <tr key={index} className="hover:bg-[#A1857A]/10 transition-colors">
                          <td className="px-6 py-4 font-semibold text-[#2E0B0F] font-sans">{request.Name}</td>
                          <td className="px-6 py-4 text-[#904945] font-sans">
                          ...
                          <td className="px-6 py-4 text-[#904945] font-sans max-w-xs truncate">
                            {request.Message || "-"}
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-[#58171D] hover:bg-[#904945] text-white rounded-lg transition-colors font-bold text-sm flex items-center gap-2 shadow-lg hover:shadow-xl"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#A1857A]/20">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Role Category</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Role Title</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Email</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#A1857A]/30">
                    {filteredEntourage.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-[#904945] font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#904945]" />
                      ...
                      filteredEntourage.map((member, index) => (
                        <tr key={index} className="hover:bg-[#A1857A]/10 transition-colors">
                          <td className="px-6 py-4 font-semibold text-[#2E0B0F] font-sans">{member.Name}</td>
                          <td className="px-6 py-4 text-[#904945] font-sans">
                            {member.RoleCategory || "-"}
                          </td>
                          <td className="px-6 py-4 text-[#904945] font-sans">
            ...
            <div className="bg-white/98 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-white/60 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#A1857A]/20">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Male Principal Sponsor</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Female Principal Sponsor</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#2E0B0F] font-sans">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#A1857A]/30">
                    {filteredPrincipalSponsors.length === 0 ? (
                      <tr>
                        <td colSpan={3} className="px-6 py-12 text-center text-[#904945] font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#904945]" />
                      ...
                      filteredPrincipalSponsors.map((sponsor, index) => (
                        <tr key={index} className="hover:bg-[#A1857A]/10 transition-colors">
                          <td className="px-6 py-4 font-semibold text-[#2E0B0F] font-sans">{sponsor.MalePrincipalSponsor}</td>
                          <td className="px-6 py-4 text-[#904945] font-sans">
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60">
        <div className="sticky top-0 bg-[#A1857A]/20 px-6 py-4 border-b-2 border-[#904945]/30 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#2E0B0F] font-sans">Add to Guest List</h3>
            <button
              onClick={onCancel}
              className="p-2 hover:bg-[#A1857A]/20 rounded-lg transition-colors text-[#904945] hover:text-[#2E0B0F]"
            >
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-base text-[#2E0B0F] font-sans leading-relaxed">
              <span className="font-bold text-lg">{request.Name}</span> is requesting to join your wedding with a total of{' '}
              <span className="font-bold text-lg text-[#58171D]">{guestCount}</span>{' '}
              {guestCount === 1 ? 'guest' : 'guests'}.
            </p>
          </div>
          
          <div className="bg-[#E6CFC9]/50 rounded-xl p-4 mb-6 border-2 border-[#A1857A]/30 shadow-sm">
            <p className="text-sm font-bold text-[#2E0B0F] mb-2 font-sans">Request Details:</p>
            <div className="space-y-2 text-sm text-[#904945] font-sans">
              ...
              {request.Message && (
                <div className="mt-2 pt-2 border-t border-[#A1857A]/30">
          ...
          <p className="text-sm text-[#904945] mb-6 font-sans">
          ...
          <div className="flex gap-3">
            <Button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 bg-[#58171D] hover:bg-[#904945] text-white disabled:opacity-50 font-bold shadow-lg"
            >
              {isLoading ? (
                <>
            ...
            <Button onClick={onCancel} variant="outline" className="px-6 border-[#A1857A]/40 text-[#904945] hover:bg-[#A1857A]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#A1857A]/20 px-6 py-4 border-b-2 border-[#904945]/30 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#2E0B0F] font-sans">{editing ? 'Edit Entourage Member' : 'Add New Entourage Member'}</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#A1857A]/20 rounded-lg transition-colors text-[#904945] hover:text-[#2E0B0F]"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#2E0B0F] mb-2 font-sans">Name *</label>
              <input
                type="text"
                value={formData.Name}
                onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
                className="w-full px-4 py-2 border-2 border-[#A1857A]/30 focus:border-[#58171D] rounded-xl text-sm font-sans placeholder:text-[#A1857A]/60 transition-all duration-300 focus:ring-4 focus:ring-[#58171D]/20 bg-white/80"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2E0B0F] mb-2 font-sans">Email</label>
              <input
                type="email"
          ...
          <div className="flex gap-3 mt-6">
            <Button
              onClick={onSave}
              disabled={isLoading}
              className="flex-1 bg-[#58171D] hover:bg-[#904945] text-white font-bold shadow-lg"
            >
              {isLoading ? (
                <>
                  <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#A1857A]/40 text-[#904945] hover:bg-[#A1857A]/20">Cancel</Button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#A1857A]/20 px-6 py-4 border-b-2 border-[#904945]/30 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#2E0B0F] font-sans">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#A1857A]/40 text-[#904945] hover:bg-[#A1857A]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60">
        <div className="sticky top-0 bg-[#A1857A]/20 px-6 py-4 border-b-2 border-[#904945]/30 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#2E0B0F] font-sans">Add New Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#A1857A]/20 rounded-lg transition-colors text-[#904945] hover:text-[#2E0B0F]"
            >
        ...
        <div className="p-6">
          <p className="text-sm text-[#904945] mb-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <input
              ...
              value={formData.Name}
              onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
              className="w-full px-4 py-3 border-2 border-[#A1857A]/30 focus:border-[#58171D] rounded-xl text-sm font-sans placeholder:text-[#A1857A]/60 transition-all duration-300 focus:ring-4 focus:ring-[#58171D]/20 bg-white/80"
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#A1857A]/40 text-[#904945] hover:bg-[#A1857A]/20">
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#A1857A]/20 px-6 py-4 border-b-2 border-[#904945]/30 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#2E0B0F] font-sans">Edit Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#A1857A]/20 rounded-lg transition-colors text-[#904945] hover:text-[#2E0B0F]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border-2 border-[#A1857A]/30 focus:border-[#58171D] rounded-xl text-sm font-sans bg-white/80 transition-all duration-300 focus:ring-4 focus:ring-[#58171D]/20"
                required
              >
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white/98 rounded-2xl shadow-2xl border-2 border-white/60">
        <div className="px-5 py-4 border-b-2 border-[#904945]/30 bg-[#A1857A]/20 rounded-t-2xl">
          <h3 className="text-base sm:text-lg font-bold text-[#2E0B0F]">{title}</h3>
        </div>
        <div className="px-5 py-4 text-sm sm:text-base text-[#904945] font-sans">
          {message}
        </div>
        <div className="px-5 py-4 flex justify-end gap-2 border-t-2 border-[#A1857A]/30">
          <button onClick={onCancel} className="px-4 py-2 text-sm rounded-lg border-2 border-[#A1857A]/40 text-[#904945] hover:bg-[#A1857A]/20 transition-colors font-semibold">Cancel</button>
